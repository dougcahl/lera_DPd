...
Bragg_noise_flag=[7 .244]; % for csw ant 9
...
N_factor=[  nanmean(nanmean(gain3(:,[(starts(1):ends(1)) (ends(2):starts(2))] ))) - lmml(n,3) ;
    nanmean(nanmean(gain3(:,[ (starts(3):ends(3)) (ends(4):starts(4))] ))) - rmml(n,3) ]';
